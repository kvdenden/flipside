...
contract MarketTest is Test {
  ...
  function test_settle() public {
    ...
    resolver.assertOutcome(address(market), Outcome.Yes);
  ...
  function test_settleNo() public {
    ...
    resolver.assertOutcome(address(market), Outcome.No);
  ...
  function test_settleInvalid() public {
    ...
    resolver.assertOutcome(address(market), Outcome.Invalid);
